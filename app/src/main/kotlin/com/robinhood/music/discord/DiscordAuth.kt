package com.robinhood.music.discord
...
import com.robinhood.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.robinhood.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.robinhood.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "robinhooddiscord://oauth2/callback"
