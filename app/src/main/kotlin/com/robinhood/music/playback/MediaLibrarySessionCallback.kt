...
import com.robinhood.music.constants.AndroidAutoSearchLocalLimitKey
...
import com.robinhood.music.constants.AndroidAutoSectionsOrderKey
import com.robinhood.music.constants.AndroidAutoYouTubePlaylistsKey
...
import com.robinhood.music.ui.screens.settings.AndroidAutoSection
import com.robinhood.music.ui.screens.settings.deserializeSections
import com.robinhood.music.ui.screens.settings.serializeSections
                ...
                val children = when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.robinhood.innertube.pages.HomePage.Section>()
