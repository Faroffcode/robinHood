...
package com.robinhood.music.widget
...
import com.robinhood.music.recognition.MusicRecognitionService
import com.robinhood.music.recognition.RecognitionForegroundService
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.ALBUM_ART_CACHE_FILE
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.PREF_ARTIST_NAME
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.PREF_COVER_ART_PATH
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.PREF_ERROR_MESSAGE
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.PREF_PULSE_FRAME
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.PREF_SONG_TITLE
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.PREF_STATE
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.PREFS_NAME
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.STATE_ERROR
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.STATE_IDLE
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.STATE_LISTENING
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.STATE_NO_MATCH
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.STATE_PROCESSING
import com.robinhood.music.recognition.RecognitionForegroundService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.robinhood.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.robinhood.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.robinhood.music.widget.recognizer.RESET"
    }
}
