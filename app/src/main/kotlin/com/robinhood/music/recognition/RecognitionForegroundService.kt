package com.robinhood.music.recognition
...
import com.robinhood.music.widget.MusicRecognizerWidgetReceiver
...
class RecognitionForegroundService : Service() {
    ...
    private fun handleSuccess(result: RecognitionResult) {
        ...
        updateNotification(
            ...
            actionTitle = getString(R.string.listen_on_robinhood),
        )
    ...
    companion object {
        ...
        const val ACTION_START_WIDGET_RECOGNITION = "com.robinhood.music.widget.recognizer.START"
        const val ACTION_STOP_WIDGET_RECOGNITION = "com.robinhood.music.widget.recognizer.STOP"
