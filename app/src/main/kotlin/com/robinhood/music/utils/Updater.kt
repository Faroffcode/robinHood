...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/RobinHoodGroup/RobinHood"
    private const val KMP_LATEST_RELEASE_URL = "https://api.github.com/repos/RobinHoodGroup/RobinHood-KMP/releases/latest"
    private const val KMP_APK_NAME = "RobinHood.apk"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "RobinHood.apk" -> "universal" to "foss"
                name == "RobinHood-with-Google-Cast.apk" -> "universal" to "gms"
