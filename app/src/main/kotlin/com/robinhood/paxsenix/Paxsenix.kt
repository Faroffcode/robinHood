package com.robinhood.paxsenix

import android.content.Context
import com.robinhood.music.betterlyrics.TTMLParser
import com.robinhood.paxsenix.models.AppleMusicSearchResponse
import com.robinhood.paxsenix.models.LyricsResponse

import com.robinhood.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(OkHttp) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "RobinHood/$appVersion")
                }
