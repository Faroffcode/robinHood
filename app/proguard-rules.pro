...
# Since RobinHood is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.robinhood.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep PO-token utility classes
-keep class com.robinhood.music.utils.potoken.** { *; }
...
-keep class com.robinhood.music.models.PersistQueue { *; }
-keep class com.robinhood.music.models.PersistPlayerState { *; }
-keep class com.robinhood.music.models.QueueData { *; }
-keep class com.robinhood.music.models.QueueType { *; }
-keep class com.robinhood.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.robinhood.music.cast.** { *; }
...
-keep class com.robinhood.music.recognition.VibraSignature { *; }
-keepclassmembers class com.robinhood.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.robinhood.music.listentogether.proto.** { *; }
-keepclassmembers class com.robinhood.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.robinhood.shazamkit.models.** { *; }
-keepclassmembers class com.robinhood.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.robinhood.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.robinhood.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.robinhood.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
